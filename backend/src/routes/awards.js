...
export default buildCrudRouter({
  ...
  fkColumn: 'award_id',
  parentColumns: ['icon_key', 'image_id', 'video_url', 'gold_count', 'silver_count', 'bronze_count', 'total_label_value', 'sort_order', 'is_published'],
  translationColumns: ['title', 'description', 'gold_label', 'silver_label', 'bronze_label', 'total_label'],
  publicColumns: ['id', 'icon_key', 'image_id', 'video_url', 'gold_count', 'silver_count', 'bronze_count', 'total_label_value', 'sort_order'],
